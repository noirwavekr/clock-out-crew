...
const THEMES = [
  { id:'orange', label:'🍊 오렌지', accent:'#ff7b35', accentL:'#ff9a56', bg:'#fef9f0', bd:'#ffe4c4', hdr:'135deg,#ff9a56,#ffb347,#ffd700', tx:'#3d2b1f', sub:'#5a3e35' },
  { id:'rose',   label:'🌸 로즈',   accent:'#e0406a', accentL:'#f0607a', bg:'#fff5f7', bd:'#ffd0da', hdr:'135deg,#f0607a,#e07090,#f5a0b0', tx:'#3a1520', sub:'#6a2535' },
  { id:'sky',    label:'🩵 스카이',  accent:'#2b8fff', accentL:'#56aaff', bg:'#f0f7ff', bd:'#c4ddff', hdr:'135deg,#4499ff,#56aaff,#88ccff', tx:'#0d2b50', sub:'#1a4070' },
  { id:'mint',   label:'🌿 민트',   accent:'#1daa80', accentL:'#2ecf99', bg:'#f0fdf8', bd:'#b8edd8', hdr:'135deg,#2ecf99,#30b890,#5ddcb0', tx:'#0d3020', sub:'#155040' },
  { id:'purple', label:'💜 퍼플',   accent:'#7c3aed', accentL:'#9d5ff5', bg:'#f8f4ff', bd:'#ddd0ff', hdr:'135deg,#9d5ff5,#7c3aed,#b890ff', tx:'#20103a', sub:'#3a1870' },
  { id:'dark',   label:'🖤 다크',   accent:'#e0a030', accentL:'#f0b840', bg:'#1a1a1a',  bd:'#333',    hdr:'135deg,#2a2a2a,#1a1a1a,#333',    tx:'#f0e8d0', sub:'#b0a080' },
  { id:'pink',   label:'🩷 핑크',   accent:'#d946a8', accentL:'#f060c0', bg:'#fff0fa', bd:'#ffd0f0', hdr:'135deg,#f060c0,#d946a8,#ff88d0', tx:'#3a0a28', sub:'#7a2060' },
  { id:'lemon',  label:'🍋 레몬',   accent:'#c4900a', accentL:'#e8b020', bg:'#fffdf0', bd:'#ffedb0', hdr:'135deg,#e8cc30,#e8b020,#ffe060', tx:'#2a1e00', sub:'#5a3e00' },
];
...
function renderThemeSwatches() {
  ...
  THEMES.forEach(theme => {
    ...
    // Swatch = mini preview of accent color + bg
    sw.style.cssText = `
    ...
    tooltip.style.cssText = `
      ...
      font-size:8px; font-weight:800; color:var(--sub); white-space:nowrap;
      pointer-events:none;
    `;
    tooltip.textContent = theme.label.split(' ')[1]||theme.label;
    sw.appendChild(tooltip);
    sw.addEventListener('mouseenter', ()=>{ sw.style.transform='scale(1.15)'; });
    sw.addEventListener('mouseleave', ()=>{ sw.style.transform=sw.classList.contains('on')?'scale(1.08)':'scale(1)'; });
